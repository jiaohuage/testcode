...
public class UiLuckyCodeRwdId implements Serializable
{
	...
	public UiLuckyCodeRwdId()
	{
	}

	public UiLuckyCodeRwdId(String svcId, String random, String winTag,
	...
	public boolean equals(Object other)
	{
		...
		if (other == null)
			return false;
		if (!(other instanceof UiLuckyCodeRwdId))
			return false;
		UiLuckyCodeRwdId castOther = (UiLuckyCodeRwdId) other;
