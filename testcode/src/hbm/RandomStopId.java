...
public class RandomStopId implements Serializable
{
	...
	public RandomStopId(String phone, String createdate, String issue)
	{
		this.phone = phone;
	...
	public boolean equals(Object other)
	{
		...
		if (other == null)
			return false;
		if (!(other instanceof RandomStopId))
			return false;
		RandomStopId castOther = (RandomStopId) other;
