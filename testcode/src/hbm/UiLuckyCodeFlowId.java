...
public class UiLuckyCodeFlowId implements Serializable
{
	private String phone;

	private String issue;

	public UiLuckyCodeFlowId()
	{
	}

	public UiLuckyCodeFlowId(String phone, String issue)
	{
		this.phone = phone;
		this.issue = issue;
	}
	...
	public boolean equals(Object other)
	{
		...
		if (other == null)
			return false;
		if (!(other instanceof UiLuckyCodeFlowId))
			return false;
		UiLuckyCodeFlowId castOther = (UiLuckyCodeFlowId) other;
